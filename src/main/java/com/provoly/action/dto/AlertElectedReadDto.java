...
public class AlertElectedReadDto extends ActionReadDto {
    private final String name;
    private final String serviceExternalId;
    private final String serviceAdditionalInfo;
    private final ServiceStatus serviceStatus;

    public AlertElectedReadDto(ActionReadDto dto, String name, String serviceExternalId, String serviceAdditionalInfo,
